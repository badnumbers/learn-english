...
The L1 is a gloss of **this English**, not a rewritten scene in the other language.
...
- Use `context` for agreement and address (speaker vs addressee gender, age, stranger vs familiar). If the English does not inflect, the L1 still may.
- Do not force two English lines apart in L1 when one natural wording covers both.
...
- If two terms are equally common, put one in the JSON and mention the other in the report.
